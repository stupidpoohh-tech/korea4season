...
**바다는 그리지 않습니다.** SVG 바탕이 비어 있어 페이지의 흰색이 그대로
바다가 됩니다. 지도 배경이 페이지 배경과 구분되지 않아야 하므로, 예전에
해안을 두르던 파란 물결 세 겹을 두지 않습니다.
색을 갖는 것은 육지와 그 위에 놓이는 생물뿐입니다.
...
- 바탕은 **흰색**이고 **바다는 그리지 않습니다.** 지도 배경이 페이지 배경과
  구분되지 않도록 파란 물결과 계절 톤 오버레이를 모두 걷어냈습니다 —
  색을 갖는 것은 육지와 그 위의 생물뿐이고, 계절은 타임라인 칩이 알립니다.
